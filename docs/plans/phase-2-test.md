...
| K9  | Update non-existent event                   | Agent attempts to update an event that was deleted externally.                                                         | Returns friendly "No event found" message. No approval card shown (404 caught before interrupt).                            | FAIL   |
